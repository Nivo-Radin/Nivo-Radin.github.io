define({ "api": [
  {
    ...
    "url": "",
    "version": "0.0.0",
    "filename": "src/app/controller/doc/main.js",
    "group": "/home/mhg/bfm-api/src/app/controller/doc/main.js",
    "groupTitle": "/home/mhg/bfm-api/src/app/controller/doc/main.js",
    "name": ""
  },
  {
    "type": "GET",
  ...
  },
  {
    "type": "PUT",
    "url": "/invoice/:id",
    "title": "Update Invoice Transactions",
    "name": "UpdateInvoiceTransactions",
    "group": "Invoice",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>List of related transactions to this invoice which has beed created via create transaction API</p>"
          },
          {
            "group": "Parameter",
            "type": "Object[]",
            "optional": false,
            "field": "transactions",
            "description": "<p>Its possible to directly create transaction here instead of calling other API</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "description": "<p>Transaction type ['INCOME', 'EXPENSE', 'TRANSFER']</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
    ...
    "sampleRequest": [
      {
        "url": "https://bfm.nivoapp.com/api/v1/invoice/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n{\n   \"message\": \"transaction updated successfully\",\n   \"transaction\": {\n       \"id\": \"1013-acf4aa6d619444b5a60a90cacd1e10b5\",\n       \"amount\": 250000,\n       \"reasonId\": \"SALE\",\n       \"customerId\": \"1011-5bf64e86dbc44342a603a5108828e62e\",\n       \"description\": \"sample_description\",\n       \"type\": \"INCOME\"\n   }\n}",
          "type": "json"
        }
      ]
    },
    ...
    "sampleRequest": [
      {
        "url": "https://bfm.nivoapp.com/api/v1/transaction/:id"
      }
    ]
  },
  {
